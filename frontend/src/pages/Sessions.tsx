...
export default function Sessions() {
  ...
  const { activeSessions, recentSessions, isLoading, error } = useSelector((state: RootState) => state.session);
  ...
  const handleEndSession = async (sessionId: string | number) => {
                          ...
                          <div className="flex-1">
                            ...
                            <div className="ml-[52px] space-y-2">
                              ...
                              <div className="flex items-center gap-1.5 text-xs text-zinc-500">
                                ...
                                <span>Created {session.createdAt ? new Date(session.createdAt).toLocaleString() : 'Unknown'}</span>
                              </div>
                            </div>
                          </div>
